...
$(window).load(function(){
    ...
    var myOptions = {
        zoom: 14,
        center: new google.maps.LatLng(-3.288808, 114.589687), //change the coordinates
    ...
    marker = new google.maps.Marker({
        map: map,
        position: new google.maps.LatLng(-3.288808, 114.589687) //change the coordinates
    });
    infowindow = new google.maps.InfoWindow({
        content: "<b>Seketariat Duta Damai Regional Kalsel</b><br/>Lantai Dua<br/> Banjarmasin"  //add your address
    });
